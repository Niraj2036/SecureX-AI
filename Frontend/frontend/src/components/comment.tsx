...
const comment = "/icons/feedback/message.png";
const like = "/icons/feedback/like.png";
  ...
  return (
    <Sheet>
      <SheetTrigger asChild  onClick={toggleComments}>
        <button>
          <Image width={28} height={28} src={comment} alt="comment" className="w-7 h-auto" />
        </button>
      </SheetTrigger>
                  ...
                  <Card className="shadow-none border-0">
                    <CardContent className="p-0">
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        ...
                        >
                          <Image width={16} height={16} src={like} alt="like" className="w-4" />
