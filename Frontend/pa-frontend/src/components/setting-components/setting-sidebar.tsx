    ...
    <div className="w-1/4 bg-white rounded-lg shadow p-4 flex flex-col mr-4">
      ...
      <nav className="flex flex-col space-y-2 mt-2">
        <Link
          href="/setting"
          className={clsx(
            "w-full flex items-center gap-2 text-black px-2 py-2 rounded-md hover:bg-muted hover:text-indigo-600",
            { "bg-muted font-semibold": pathname === "/setting" }
          )}
        >
        ...
        <Link
          ...
          className={clsx(
            "w-full flex items-center gap-2 text-black px-2 py-2 rounded-md hover:bg-muted hover:text-indigo-600",
            { "bg-muted font-semibold": pathname === "/setting/departments" }
          )}
        >
        ...
        <Link
          ...
          className={clsx(
            "w-full flex items-center gap-2 text-black px-2 py-2 rounded-md hover:bg-muted hover:text-indigo-600",
            { "bg-muted font-semibold": pathname === "/setting/teams" }
          )}
        >
