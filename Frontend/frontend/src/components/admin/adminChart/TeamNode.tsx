...
const TeamNode = ({ data }: any) => {
  return (
    <div
      className="bg-card backdrop-blur-lg border border-border/80 transition-all duration-300 hover:shadow-xl hover:border-emerald-500/50 w-[280px] rounded-2xl p-4 shadow-md text-left cursor-pointer"
    >
