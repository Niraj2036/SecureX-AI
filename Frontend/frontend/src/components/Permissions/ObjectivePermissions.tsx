...
const ObjectivePermissions = () => {
    ...
    const visibilityOptions: VisibilityOption[] = [
        {
            value: 'all',
            label: 'All',
            description: 'Profile visible to everyone in the organization',
            icon: <Users className="h-4 w-4" />
        },
        {
            value: 'team',
            label: 'Team',
            description: 'Profile visible only to team members',
            icon: <Users className="h-4 w-4" />
        },
        {
            value: 'self',
            label: 'Self',
            description: 'Profile visible only to the user',
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="mb-6">
                <h1 className="text-xl font-bold mb-2">Profile Permissions</h1>
                <p className="text-gray-600">Manage which profiles users can see across the organization</p>
            </div>
