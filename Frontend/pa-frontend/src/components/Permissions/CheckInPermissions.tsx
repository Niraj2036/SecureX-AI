...
const CheckInPermissions = () => {
    ...
    const visibilityOptions: VisibilityOption[] = [
        {
            value: "all",
            label: "All",
            description: "CheckIn visible to everyone in the organization",
            icon: <Users className="h-4 w-4" />,
        },
        {
            value: "team",
            label: "Team",
            description: "CheckIn visible only to team members",
            icon: <Users className="h-4 w-4" />,
        },
        {
            value: "self",
            label: "Self",
            description: "CheckIn visible only to the user",
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="mb-6">
                <h1 className="text-xl font-bold mb-2">CheckIn Permissions </h1>
                <p className="text-gray-600">Manage which CheckIn users can see across the organization</p>
            </div>
                                    ...
                                    {expandedUserId === user.id && (
                                        <div className="p-4 bg-white">
                                            <div className="grid md:grid-cols-2 gap-6">
                                                ...
                                                <div>
                                                    <h4 className="font-medium mb-3">CheckIn Visibility</h4>
