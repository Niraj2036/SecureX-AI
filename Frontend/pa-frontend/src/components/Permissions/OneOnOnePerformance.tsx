...
const OneOnOnePermissions = () => {
    ...
    const visibilityOptions: VisibilityOption[] = [
        {
            value: 'all',
            label: 'All',
            description: '1on1 visible to everyone in the organization',
            icon: <Users className="h-4 w-4" />
        },
        {
            value: 'team',
            label: 'Team',
            description: '1on1 visible only to team members',
            icon: <Users className="h-4 w-4" />
        },
        {
            value: 'self',
            label: 'Self',
            description: '1on1 visible only to the user',
    ...
    useEffect(() => {
        if (userData?.data && Array.isArray(userData.data)) {
            ...
            userData.data.forEach((user: Employee) => {
                const visibility = user.oneOnOneVisibility as ObjectiveVisibility || 'team';
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="mb-6">
                <h1 className="text-xl font-bold mb-2">1 on 1 Permissions</h1>
                <p className="text-gray-600">Manage which 1 on 1 users can see across the organization</p>
            </div>
                                    ...
                                    {expandedUserId === user.id && (
                                        <div className="p-4 bg-white">
                                            <div className="grid md:grid-cols-2 gap-6">
                                                ...
                                                <div>
                                                    <h4 className="font-medium mb-3">1 on 1 Visibility</h4>
...
export default OneOnOnePermissions;