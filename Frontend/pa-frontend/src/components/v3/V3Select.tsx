    ...
    return (
      <div className="space-y-1 w-full">
        ...
        <div className="relative flex items-center w-full">
          <select
            ref={ref}
            className={`w-full h-9 rounded-lg border border-border/80 bg-background px-3 pr-8 text-xs text-foreground appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all ${
