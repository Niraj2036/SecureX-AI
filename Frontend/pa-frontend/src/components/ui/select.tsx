...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-6 w-6 bg-muted text-muted-foreground rounded-full p-1" />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 p-2 text-sm font-semibold", className)}
    {...props}
  >
    <div className=" inline-flex justify-between items-center w-full py-2">
      ...
      <SelectPrimitive.Icon asChild>
        <>
          <X className="h-6 w-6 bg-muted text-muted-foreground rounded-full p-1" />
