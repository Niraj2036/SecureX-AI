...
const bag = "/settings/bag.png";
const pen = "/settings/pen.png";
const target = "/okr/target.png";
      ...
      <div className="flex p-4 bg-gray-100 min-h-screen">
        <div className="w-1/4 bg-white rounded-lg shadow p-4 mr-4">
          ...
          <Button
            ...
            className={`bg-white w-full text-black rounded-lg py-2 justify-start ${activeTab === "Objective" ? "text-indigo-600 bg-muted" : ""
              } hover:bg-muted hover:text-indigo-600`}
          >
          ...
          <Button
            ...
            className={`bg-white w-full text-black rounded-lg mt-2 py-2 justify-start ${activeTab === "CheckIn" ? "text-indigo-600 bg-muted" : ""
              } hover:bg-muted hover:text-indigo-600`}
          >
          ...
          <Button
            ...
            className={`bg-white w-full text-black rounded-lg mt-2 py-2 justify-start ${activeTab === "OneOnOne" ? "text-indigo-600 bg-muted" : ""
              } hover:bg-muted hover:text-indigo-600`}
          >
          ...
          <Button
            ...
            className={`bg-white w-full text-black rounded-lg mt-2 py-2 justify-start ${activeTab === "Performance" ? "text-indigo-600 bg-muted" : ""
              } hover:bg-muted hover:text-indigo-600`}
          >
